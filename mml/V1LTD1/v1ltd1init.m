...
AO.HCM.Monitor.ChannelNames = { 'LTB:MG{HCor:1}Fld-I';'LTB:MG{HCor:2}Fld-I';'LTB:MG{HCor:1BD1}Fld-I';'LTB:MG{HCor:2BD1}Fld-I' };
...
AO.HCM.Setpoint.ChannelNames = { 'LTB:MG{HCor:1}Fld-SP';'LTB:MG{HCor:2}Fld-SP';'LTB:MG{HCor:1BD1}Fld-SP';'LTB:MG{HCor:2BD1}Fld-SP' };
...
AO.HCM.OnControl.ChannelNames = { 'fakepv';'fakepv';'fakepv';'fakepv' };
...
AO.HCM.Fault.ChannelNames = { 'fakepv';'fakepv';'fakepv';'fakepv' };
...
AO.VCM.Position    = [];
AO.VCM.CommonNames = [ '   cy1';'   cy2';'cy1bd1';'cy2bd1' ];
...
AO.VCM.Monitor.ChannelNames = { 'LTB:MG{VCor:1}Fld-I';'LTB:MG{VCor:2}Fld-I';'LTB:MG{VCor:1BD1}Fld-I';'LTB:MG{VCor:2BD1}Fld-I' };
...
AO.VCM.Setpoint.ChannelNames = { 'LTB:MG{VCor:1}Fld-SP';'LTB:MG{VCor:2}Fld-SP';'LTB:MG{VCor:1BD1}Fld-SP';'LTB:MG{VCor:2BD1}Fld-SP' };
...
AO.VCM.OnControl.ChannelNames = { 'fakepv';'fakepv';'fakepv';'fakepv' };
...
AO.VCM.Fault.ChannelNames = { 'fakepv';'fakepv';'fakepv';'fakepv' };
...
AO.Q.DeviceList = [ 1 1; 1 2; 1 3; 1 4; 1 5 ];
AO.Q.ElementList = (1:size(AO.Q.DeviceList,1))';
AO.Q.Status = ones(size(AO.Q.DeviceList,1),1);
AO.Q.Position = [];
AO.Q.CommonNames = [ '   q1';'   q2';'   q3';'q1bd1';'q2bd1' ];

AO.Q.Monitor.MemberOf = {'QUAD'; 'Magnet'; 'PlotFamily'; 'Monitor'; 'Save';};
AO.Q.Monitor.Mode = 'Simulator';
AO.Q.Monitor.DataType = 'Scalar';
AO.Q.Monitor.ChannelNames = { 'LTB:MG{Quad:1}Fld-I';'LTB:MG{Quad:2}Fld-I';'LTB:MG{Quad:3}Fld-I';'LTB:MG{Quad:1BD1}Fld-I';'LTB:MG{Quad:2BD1}Fld-I' };
...
AO.Q.Setpoint.ChannelNames = { 'LTB:MG{Quad:1}Fld-SP';'LTB:MG{Quad:2}Fld-SP';'LTB:MG{Quad:3}Fld-SP';'LTB:MG{Quad:1BD1}Fld-SP';'LTB:MG{Quad:2BD1}Fld-SP' };
...
AO.Q.OnControl.ChannelNames = { 'fakepv';'fakepv';'fakepv';'fakepv';'fakepv' };
...
AO.Q.Fault.ChannelNames = { 'fakepv';'fakepv';'fakepv';'fakepv';'fakepv' };
...
AO.Screen.DeviceList = [ 1 1; 1 2; 1 3; 1 4 ];
...
AO.Screen.CommonNames = [ '   vf1';'vf1bd1';'vf2bd1';'vf3bd1' ];
