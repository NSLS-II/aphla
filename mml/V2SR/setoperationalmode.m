...
AD.Energy          = 3;  % make sure this is the same as bend2gev at the production lattice!
AD.InjectionEnergy = 3;

% AT lattice
AD.ATModel = 'nsls2v2sr';
nsls2v2sr(AD.Energy*1e9);

if ModeNumber == 1
    % 200 MeV Injection
    AD.OperationalMode = '3 GeV';
    ModeName = '50MEV';
    OpsFileExtension = '_V2SR';
        
elseif 101
    
    % Model mode
    AD.OperationalMode = 'Model V2SR Mode';
    ModeName = 'Model';
...
elseif 999
    ...
    % Test mode
    AD.OperationalMode = 'Test V2SR Mode';
    ModeName = 'Test';
    OpsFileExtension = '_V2SR';
