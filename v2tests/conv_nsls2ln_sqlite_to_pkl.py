...
Convert the contents of /epics/aphla/apconf/nsls2/nsls2_LN.sqlite as of
...
# v1 aphla unit conversion file: No unit conversion file for LN exists.
...
#[('I', ['LN-BI{BPM:1}I-I']),
 #('goldenX', []),
 #('goldenY', []),
 #('x', ['LN-BI{BPM:1}Pos:X-I']),
 #('y', ['LN-BI{BPM:1}Pos:Y-I'])]

# >> [(fld, e._field[fld].pvsp) for fld in e.fields()]
#[('I', []),
 #('goldenX', ['LN-BI{BPM:1}Pos:UsrXoffset-SP']),
 #('goldenY', ['LN-BI{BPM:1}Pos:UsrYoffset-SP']),
 #('x', []),
 #('y', [])]
...
v1aphal_elem_names = ['P1', 'P2', 'P3', 'P4', 'P5']
