...
Convert the contents of /epics/aphla/apconf/nsls2/nsls2_LTD2.sqlite as of
...
# ^ Note that LTB unitconv file is being used also for LTD2, as some elements
#   of LTD2 are shared with LTB lattice.

#>> ap.getGroups()
#['BPM', 'FLAG', 'VCOR', 'HCOR', 'QUAD', 'ICT', 'BEND', 'FCT', 'FC', 'HLA:VIRTUAL']
