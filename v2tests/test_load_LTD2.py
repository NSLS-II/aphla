...
if TEST_NAME == 'elem_pvs':
    ...
    field_list = [
        'I', 'Q', 'Qerr', 'acquire',
        'b0', 'b1', 'centroidX', 'centroidY', 'goldenX', 'goldenY',
        'imageName', 'imageNumber', 'minX', 'minY', 'nBunches', 'nCapture',
        'position', 'ramping', 'saveImage', 'sigmaX', 'sigmaY', 'sizeX', 'sizeY',
        'x', 'y',
    ]
