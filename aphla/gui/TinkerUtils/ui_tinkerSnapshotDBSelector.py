...
#
# Created: Mon Apr 14 13:33:18 2014
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBox_ss_id_1.setObjectName(_fromUtf8("comboBox_ss_id_1"))
        self.comboBox_ss_id_1.addItem(_fromUtf8(""))
        self.comboBox_ss_id_1.setItemText(0, _fromUtf8(""))
        self.comboBox_ss_id_1.addItem(_fromUtf8(""))
        self.comboBox_ss_id_1.addItem(_fromUtf8(""))
        self.comboBox_ss_id_1.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.comboBox_ss_id_1, 0, 1, 1, 1)
        self.lineEdit_ss_id_1 = QtGui.QLineEdit(self.groupBox_search_params)
        self.lineEdit_ss_id_1.setObjectName(_fromUtf8("lineEdit_ss_id_1"))
        ...
        self.comboBox_ss_id_2.setObjectName(_fromUtf8("comboBox_ss_id_2"))
        self.comboBox_ss_id_2.addItem(_fromUtf8(""))
        self.comboBox_ss_id_2.setItemText(0, _fromUtf8(""))
        self.comboBox_ss_id_2.addItem(_fromUtf8(""))
        self.comboBox_ss_id_2.addItem(_fromUtf8(""))
        self.comboBox_ss_id_2.addItem(_fromUtf8(""))
        self.gridLayout.addWidget(self.comboBox_ss_id_2, 0, 4, 1, 1)
        self.lineEdit_ss_id_2 = QtGui.QLineEdit(self.groupBox_search_params)
        self.lineEdit_ss_id_2.setObjectName(_fromUtf8("lineEdit_ss_id_2"))
        self.gridLayout.addWidget(self.lineEdit_ss_id_2, 0, 5, 1, 3)
        ...
        self.gridLayout.addWidget(self.lineEdit_config_id_2, 1, 5, 1, 3)
        ...
        self.gridLayout.addWidget(self.lineEdit_ref_step_size_2, 2, 5, 1, 3)
        ...
        self.lineEdit_ss_name.setObjectName(_fromUtf8("lineEdit_ss_name"))
        self.gridLayout.addWidget(self.lineEdit_ss_name, 3, 1, 1, 7)
        ...
        self.lineEdit_ss_description.setObjectName(_fromUtf8("lineEdit_ss_description"))
        self.gridLayout.addWidget(self.lineEdit_ss_description, 4, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.lineEdit_username, 5, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.dateTimeEdit_time_created_2, 6, 5, 1, 3)
        ...
        self.gridLayout.addWidget(self.lineEdit_masar_id_2, 7, 5, 1, 3)
        ...
        self.checkBox_hide_NG = QtGui.QCheckBox(self.groupBox_search_params)
        self.checkBox_hide_NG.setChecked(True)
        self.checkBox_hide_NG.setObjectName(_fromUtf8("checkBox_hide_NG"))
        self.gridLayout.addWidget(self.checkBox_hide_NG, 8, 6, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_search, 8, 7, 1, 1)
        ...
        self.groupBox_selected_ss.setObjectName(_fromUtf8("groupBox_selected_ss"))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setToolTip(QtGui.QApplication.translate("Dialog", "Exclude snapshots marked as \"No Good\" ($NG$ in Snapshot Name)", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_preferences.setText(QtGui.QApplication.translate("Dialog", "Preferences", None, QtGui.QApplication.UnicodeUTF8))
        self.groupBox_search_params.setToolTip(QtGui.QApplication.translate("Dialog", "Exclude snapshots marked as \"No Good\" ($NG$ in Snapshot Name)", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.checkBox_hide_NG.setToolTip(QtGui.QApplication.translate("Dialog", "Exclude snapshots marked as \"No Good\" ($NG$ in Snapshot Name)", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_hide_NG.setText(QtGui.QApplication.translate("Dialog", "Hide $NG$", None, QtGui.QApplication.UnicodeUTF8))
