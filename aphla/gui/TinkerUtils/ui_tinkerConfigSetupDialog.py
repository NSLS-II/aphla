...
#
# Created: Sat Mar 22 17:50:57 2014
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.pushButton_addRows = QtGui.QPushButton(self.layoutWidget1)
        self.pushButton_addRows.setObjectName(_fromUtf8("pushButton_addRows"))
        self.gridLayout.addWidget(self.pushButton_addRows, 0, 0, 1, 1)
        self.pushButton_removeRows = QtGui.QPushButton(self.layoutWidget1)
        self.pushButton_removeRows.setObjectName(_fromUtf8("pushButton_removeRows"))
        self.gridLayout.addWidget(self.pushButton_removeRows, 0, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.checkBox_synced_group_weight, 1, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.lineEdit_ref_step_size, 2, 2, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_masar_id, 3, 2, 1, 2)
        ...
        self.lineEdit_config_name = QtGui.QLineEdit(self.layoutWidget2)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_addRows.setText(QtGui.QApplication.translate("Dialog", "Add Rows", None, QtGui.QApplication.UnicodeUTF8))
        self.pushButton_removeRows.setText(QtGui.QApplication.translate("Dialog", "Remove Rows", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.pushButton_export.setText(QtGui.QApplication.translate("Dialog", "Save to Database", None, QtGui.QApplication.UnicodeUTF8))
