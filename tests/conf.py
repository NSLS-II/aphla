...
#    logger.info("using HLA_ROOT=%s" % HLA_ROOT)
#else:
#    HLA_ROOT = os.environ['HLA_ROOT']
#    logger.info("using environment HLA_ROOT=%s" % HLA_ROOT)
...
#logger.info("using data HLA/CFA/LATCONF in %s/" % __RT)
...
#logger.info("using data ORMX/ORMY/ORM in %s/" % __RT)
