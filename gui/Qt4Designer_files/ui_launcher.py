...
#
# Created: Tue Feb 28 15:02:26 2012
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.treeViewSide = QtGui.QTreeView(self.splitterPanes)
        self.treeViewSide.setObjectName(_fromUtf8("treeViewSide"))
        ...
        self.treeViewMain = QtGui.QTreeView(self.page)
        self.treeViewMain.setObjectName(_fromUtf8("treeViewMain"))
        self.gridLayout.addWidget(self.treeViewMain, 0, 0, 1, 1)
        self.stackedWidgetMainPane.addWidget(self.page)
        self.page_2 = QtGui.QWidget()
        self.page_2.setObjectName(_fromUtf8("page_2"))
        self.gridLayout_2 = QtGui.QGridLayout(self.page_2)
        self.gridLayout_2.setContentsMargins(-1, 0, 0, 0)
        self.gridLayout_2.setObjectName(_fromUtf8("gridLayout_2"))
        self.listViewMain = QtGui.QListView(self.page_2)
        self.listViewMain.setObjectName(_fromUtf8("listViewMain"))
        self.gridLayout_2.addWidget(self.listViewMain, 0, 0, 1, 1)
        self.stackedWidgetMainPane.addWidget(self.page_2)
        ...
        self.actionDetails.setObjectName(_fromUtf8("actionDetails"))
        self.actionVisible_Columns = QtGui.QAction(MainWindow)
        self.actionVisible_Columns.setObjectName(_fromUtf8("actionVisible_Columns"))
        self.actionSide_Pane = QtGui.QAction(MainWindow)
        self.actionSide_Pane.setObjectName(_fromUtf8("actionSide_Pane"))
        ...
        self.menuView.addAction(self.actionVisible_Columns)
        self.menuView.addSeparator()
        self.menuView.addAction(self.actionSide_Pane)
        ...
        self.stackedWidgetMainPane.setCurrentIndex(1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_search.setPlaceholderText(QtGui.QApplication.translate("MainWindow", "search", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.actionIcons.setText(QtGui.QApplication.translate("MainWindow", "Icons", None, QtGui.QApplication.UnicodeUTF8))
        self.actionList.setText(QtGui.QApplication.translate("MainWindow", "List", None, QtGui.QApplication.UnicodeUTF8))
        self.actionDetails.setText(QtGui.QApplication.translate("MainWindow", "Details", None, QtGui.QApplication.UnicodeUTF8))
        self.actionVisible_Columns.setText(QtGui.QApplication.translate("MainWindow", "Visible Columns...", None, QtGui.QApplication.UnicodeUTF8))
        self.actionSide_Pane.setText(QtGui.QApplication.translate("MainWindow", "Side Pane", None, QtGui.QApplication.UnicodeUTF8))
