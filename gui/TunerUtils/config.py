...
DICT_COL = { #Level, Property Name, String Format
    ...
    COL_CURR_RB: ['channel','',STR_FORMAT_PV_VAL],
    COL_CURR_SP: ['channel','',STR_FORMAT_PV_VAL],
    COL_CURR_RB_TIME: ['channel','','timestamp'],
    COL_CURR_SP_TIME: ['channel','','timestamp'],
    COL_SNAPSHOT_RB: ['channel','',STR_FORMAT_PV_VAL],
    COL_SNAPSHOT_SP: ['channel','',STR_FORMAT_PV_VAL],
    COL_SNAPSHOT_RB_TIME: ['channel','','timestamp'],
    COL_SNAPSHOT_SP_TIME: ['channel','','timestamp'],
    COL_TARGET_SP: ['channel','',STR_FORMAT_PV_VAL],
    COL_D_TARGET_SP_CURR_SP: ['channel','',STR_FORMAT_PV_VAL],
    COL_INIT_RB: ['channel','',STR_FORMAT_PV_VAL],
    COL_INIT_SP: ['channel','',STR_FORMAT_PV_VAL],
    COL_INIT_RB_TIME: ['channel','','timestamp'],
    COL_INIT_SP_TIME: ['channel','','timestamp'],
    COL_D_CURR_RB_INIT_RB: ['channel','',STR_FORMAT_PV_VAL],
    COL_D_CURR_SP_INIT_SP: ['channel','',STR_FORMAT_PV_VAL],
    COL_D_CURR_RB_CURR_SP: ['channel','',STR_FORMAT_PV_VAL],
