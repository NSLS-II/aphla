...
if __name__ == "__main__":
    ...
    # In this script, we're adding C09 CDI ID.
    straight_cell_num = 9

    # As of 09/05/2025 with the layout including up to C09 CDI.
    # In this script, we will add 2 new ID BPMs for C09 CDI. So, next time you
    # update this script, this number should be raised to 49.
    n_existing_ubpms = 47
    ...
    #   Non-DW 18th ID = HEX
    #   Non-DW 19th ID = IFE
    #   Non-DW 20th ID = CDI (being added in this script)
    #
    # There are 3 damping wigglers (2 each) plus 19 non-DW IDs before new addition.
    # In this script, we will add one new kickmap for C09 CDI. So, next time you
    # update this script, `_n_ex_non_dw_ukickmaps` should be raised to 20.
    _n_ex_dw_ukickmaps = 3 * 2
    _n_ex_non_dw_ukickmaps = 19
    ...
    # As of 09/05/2025, it was "../20230915/20230915_aphla_layout_RelKMPaths.lte".
    # (But I had to manually fix the KM rel. path from "./kickmaps/..." to
    # "../../kickmaps/..." in that file and put it under "old_LTE_fixed". This
    # operation shouldn't be necessary next time.)
    # So, next time you update this script, it should be changed to:
    #  path=Path("../20250905/new_LTEs/20250905_aphla_layout_RelKMPaths.lte")
    LTE_files['layout']['orig'] = LayoutLatticeFile(
        path=Path("20230915_aphla_layout_RelKMPaths_manually_fixed.lte"),
        with_xbpms=False,
    )
